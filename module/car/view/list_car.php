              ...
              <div class="col-lg-12">
                <div class="menu">
                  <div class="first-thumb active">
                    <div class="thumb">
                      <span class="icon"><img src="view/images/search-icon-01.png" alt="">
                        <h4>Apartments</h4>
                      </span>
                    </div>
                  </div>
                  <div>
                    <div class="thumb">
                      <span class="icon"><img src="view/images/search-icon-02.png" alt="">
                        <h4>Food &amp; Life</h4>
                      </span>
                    </div>
                  </div>
                  <div>
                    <div class="thumb">
                      <span class="icon"><img src="view/images/search-icon-03.png" alt="">
                        <h4>Cars</h4>
                      </span>
                    </div>
                  </div>
                  <div>
                    <div class="thumb">
                      <span class="icon"><img src="view/images/search-icon-04.png" alt="">
                        <h4>Shopping</h4>
                      </span>
                    </div>
                  </div>
                  <div class="last-thumb">
                    <div class="thumb">
                      <span class="icon"><img src="view/images/search-icon-05.png" alt="">
                        <h4>Traveling</h4>
                      </span>
                    </div>
                  </div>
                        ...
                        <div class="row">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6">
                                  <div class="main-white-button">
                                    ...
                                    <a href="index.php?module=car&op=create"><i class="fa fa-plus"></i>Create Cars</a>
                                    <a href="index.php?module=car&op=create_dummies"><i class="fa fa-plus"></i>Dummies</a>
                                    <a href="index.php?module=car&op=delete_all"><i class="fa fa-plus"></i> Delete Cars</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-lg-12">
                            <div class="row">
                              ...
                              ?>
                                  <div class="col-md-4 mt-10 cardk">
                                    <a href="" class="no-link">
                                      <div class="card">
                                        ...
                                        <div class="desc">
                                          ...
                                          <div class="km">
                                            <img src="view/icons/road.svg" alt="">
                                            <!-- 100000 km -->
                                            <?= $row['km'] ?> km
                                          </div>
                                          <div class="cv">
                                            <img src="view/icons/cv.svg" alt="">
                                            <!-- 90 cv -->
                                            <?= $row['cv'] ?> cv
                                          </div>
                                    ...
                                    <div class="cont">
                                      <div class="btn btn-showmodal btn-show" data-id="<?= $row['id'] ?>">
                                        <img src="view/icons/eye.svg" alt="">
                            ...
                            <div class="description">
                              <div class="row">
                                <div class="col-lg-9">
                                  ...
                                  <p>If you feel that Plot Listing HTML template is useful, please <a rel="nofollow" href="https://www.paypal.me/templatemo" target="_blank">support us</a> a little
                                ...
                                <div class="col-lg-3">
                                  <div class="text-icon">
                                    <h4><img src="view/images/listing-icon-heading.png" alt=""> Total Listings</h4>
                                  </div>
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                  ...
                                  <span class="list-item">* Listing should have all the proper documents before being
                                    ...
                                    <br>*** After being sold, it should imediately be removed from our site and properly
                                    monitored.</span>
                                </div>
                              </div>
                            </div>
