...
function loadMarksCarousel() {
    ajaxPromise('module/mark/controller/controller_mark.php?op=list_marks', 'GET', 'json')
        .then(function (data) {
...
function loadCategories(lim) {
    ajaxPromise('module/category/controller/controller_category.php?op=list_categories&lim=' + lim, 'GET', 'json')
        .then(function (data) {
...
var news = null
var contNews = 5
{/* <div class="grid-container g01">
    <div class="item grid-cell-1">
        <div class="img">
            <img src="" alt="" srcset="">
        </div>
        <div class="cont">
